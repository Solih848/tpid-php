...
<head>
  ...
  <style>
    ...
    #kontak p svg {
      margin-right: 5px; /* Sesuaikan nilai ini dengan jarak yang Anda inginkan */
      width: 12px; /* Sesuaikan lebar ikon */
      height: 12px; /* Sesuaikan tinggi ikon */
...
<body id="afu">
  ...
  <footer class="footer">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-5 text-center" id="col3">
          <div class="logo">
            <a href="#"><img id="logo-image" src="icon/Logo.png?v=<?php echo time(); ?>" alt="Logo TPID SUMENEP" style="width: 100px; "></a>
          <p style="margin-top: 10px;">Dikelola oleh Tim Pengendali Inflasi Daerah Kabupaten Sumenep</p>
        </div>
        </div>
        <div class="col-md-2">
          ...
          <ul class="no-bullet">
            <li>Ali Fikri</li>
            <li>Abror Al Mubarok</li>
            <li>Nur Fawait</li>
            <li>Dhimas Andy Akbar</li>
            <p>(Teknik Informatika - Universitas Bahauddin Mudhary Madura)</p>
          </ul>
          <h5>Pembimbing:</h5>
          <ul class="no-bullet">
            <li>Irwan Sujatmiko</li>
            <p>(Kepala Bidang IKP Diskominfo Sumenep)</p>
          </ul>
        </div>

        <div class="col-sm-2" id="kontak">
        <h5>Kontak</h5>
      ...
      Senin-Kamis: 07.30-15.30</p>

          <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
        <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z"/>
      </svg>
      Jum'at: 06.00-15.30</p>
      </div>

<!-- Media sosial -->
        <div class="col-md-2 text-center" id="medsos">
        <h5>Media Sosial</h5>
...
<!-- end media sosial -->
      ...
      <div class="row">
        <div class="col">
          <p class="text-center" id="copy">© 2024 Kabupaten Sumenep</p>
        </div>
      </div>
      </div>
      </div>
