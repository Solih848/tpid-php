...
<head>
    ...
    <title>TPID | Login Operator Pasar</title>
...
<body>
    <div class="card">
        <h1>Login Operator Pasar</h1>
        <form method="post" action="proses_login.php">
            <label for="username">Username:</label>
            <input type="text" id="username" name="username" autocomplete="off" placeholder="Masukkan Nama Lengkap" required>
