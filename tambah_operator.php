...
<head>
    ...
    .card {
        ...
        margin: 10px auto; /* Untuk menengahkan kartu di layar */
    }
}
            ...
            <div class="container-fluid px-4">
                <div class="card" style="margin-top:20px">
                    <div class="card-header">
                        <h1 class="card-title">Tambah Operator</h1>
                    </div>
                    <div class="card-body">
                        <form method="post" action="proses_tambah_operator.php">
                            <div class="form-group">
                                <label for="username">Nama Operator:</label>
                            ...
                            <button type="submit" class="btn btn-primary" style="margin-top: 20px;">Tambah Operator</button>
