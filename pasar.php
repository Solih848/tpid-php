...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["nama_pasar"])) {
        ...
        $sql = "INSERT INTO pasar (nama_pasar) VALUES ('$namaPasar')";
...
<head>
    ...
    <title>Halaman Edit Pasar</title>
    <meta charset="utf-8" />
            ...
            <div class="container-fluid px-4" style="margin-top:20px;">
                    ...
                    <div class="input-container"> <!-- Tambahkan div ini sebelum form tambah -->
                        <div class="form-tambah" id="formTambah" style="display: none;">
                            <form id="formTambahPasar" method="post" onsubmit="return validateForm()">
                                <input type="text" name="nama_pasar" id="nama_pasar" class="input-tambah" placeholder="Nama Pasar">
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td>" . $no . "</td>";
                                        echo "<td style='text-align: left;'>" . $row['nama_pasar'] . "</td>";
                                        echo "<td style='text-align: center;'>";
                                        echo "<button class='btn btn-update' onclick='showUpdateForm(" . $row['id'] . ", \"" . $row['nama_pasar'] . "\")'>Update</button>";
                ...
                <div class="form-update" id="formUpdatePasar">
                    <form onsubmit="return submitForm()" id="formUpdatePasarForm">
                        ...
                        <input type="text" name="nama_pasar" id="update_nama_pasar" class="input-update" placeholder="Nama Pasar">
                ...
                <script>
                    ...
                    function deletePasar(id) {
                        if (confirm('Apakah Anda yakin ingin menghapus pasar ini?')) {
                            ...
                            xhr.onreadystatechange = function() {
                                if (xhr.readyState === XMLHttpRequest.DONE) {
                                    if (xhr.status === 200) {
                                        ...
                                        alert('Terjadi kesalahan saat menghapus pasar.');
                                    }
                                }
                            };
                            xhr.open("POST", "hapus_pasar.php", true);
                    ...
                    function validateForm() {
                        ...
                        if (namaPasar == "") {
                            alert("Nama pasar tidak boleh kosong.");
                            return false;
                        }
                        return true;
                    }
                    ...
                    function submitForm() {
                        ...
                        xhr.open("POST", "update_pasar.php", true);
                        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                        xhr.send("id=" + id + "&nama_pasar=" + encodeURIComponent(namaPasar));
